		...
		<div class="container-fluid">
			<div class="row">
				<div class="big_text panel panel-default col-md-10 col-xs-10 col-md-offset-1 col-xs-offset-1">	<br/>
					...
					<form role="form" action="/abs/pages/time_dep_confirmation.php?edom=<?php echo $voodoo ?>" method="POST" >
						<?php
					...
					<br/> 
					<br/> 
					 <input type="submit" class="btn btn-info col-md-12 col-xs-12" name="deposit_rep" value="DEPOSIT">
					</form>
						</div>
					<br/>
				</div>
